    ...
    return (
        <div>
            ...
            <Togglable label="Create new blog" ref={viewRef}>
                <BlogCreation handleBlogCreation={handleBlogCreation} viewRef={viewRef} />
            </Togglable>
            <p>Contents</p>
            <BlogList blogs={blogs} user={user} handleLike={handleLike} setMessage={setMessage} handleDelete={handleDelete} />
        </div>
    )
}
